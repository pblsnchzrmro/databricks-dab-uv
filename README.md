...
The 'uvdatabricks' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] uvdatabricks_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/uvdatabricks.job.yml). The schedule
